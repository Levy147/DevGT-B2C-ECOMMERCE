...
URL del sitio (este repo):

**https://levy147.github.io/DevGT-B2C-ECOMMERCE/**

El workflow publica el build de Vite en la carpeta **`docs/`** de la rama `main`. El archivo **`.nojekyll`** evita que GitHub use Jekyll.

### Activar Pages (obligatorio, una sola vez)

1. Abre: [github.com/Levy147/DevGT-B2C-ECOMMERCE/settings/pages](https://github.com/Levy147/DevGT-B2C-ECOMMERCE/settings/pages)
2. En **Build and deployment → Source**, elige **Deploy from a branch**.
3. **Branch:** `main` · **Folder:** `/docs`
4. Clic en **Save**.
5. Espera 1–3 minutos y entra a la URL de arriba.

Si ves *"There isn't a GitHub Pages site here"*, es porque **Pages no está activado** en Settings (el build ya puede estar bien).

### Actualizaciones automáticas

Cada push a `main` (excepto cambios solo en `docs/`) ejecuta el workflow y actualiza la carpeta `docs/`.
