...
export const CATEGORIES = [
  ...
  { slug: 'bebidas', name: 'Bebidas', icon: Coffee, color: 'from-amber-700 to-amber-900', image: 'https://images.unsplash.com/photo-1628035280603-74ca33b17259?w=600&h=400&fit=crop' },
  ...
  { slug: 'limpieza', name: 'Limpieza', icon: Droplets, color: 'from-cyan-500 to-teal-600', image: 'https://images.unsplash.com/photo-1644169633221-4dbd3f247211?w=600&h=400&fit=crop' },
