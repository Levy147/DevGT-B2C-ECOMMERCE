...
export const CATEGORIES = [
  ...
  { slug: 'lacteos', name: 'Lácteos', icon: Milk, color: 'from-blue-400 to-blue-600', image: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=600&h=400&fit=crop' },
  { slug: 'panaderia', name: 'Panadería', icon: Croissant, color: 'from-yellow-500 to-orange-600', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&h=400&fit=crop' },
  ...
  { slug: 'snacks', name: 'Snacks', icon: Cookie, color: 'from-pink-500 to-rose-600', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=600&h=400&fit=crop' },
...
export const SPECIAL_CATEGORIES = [
  { slug: 'ofertas', name: 'Ofertas', icon: Tag, color: 'from-red-500 to-red-700', badge: '🔥', description: 'Descuentos imperdibles' },
  { slug: 'lo-nuevo', name: 'Lo Nuevo', icon: Star, color: 'from-violet-500 to-violet-700', badge: '✨', description: 'Recién llegados a la tienda' },
  { slug: 'mayoreo', name: 'Mayoreo', icon: Boxes, color: 'from-forest to-deep', badge: '📦', description: 'Precios especiales por volumen' },
]
